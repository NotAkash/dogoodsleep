...
export function MainNav() {
  ...
  return (
    <header className="site-header sticky top-0 z-30 w-full bg-[var(--paper)]">
      <nav
          ...
          {links.map((link) => {
            ...
            return (
              <Link
                ...
                className={`border-b py-1 text-[10px] font-medium uppercase tracking-[0.15em] transition-opacity hover:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--ink)] sm:text-[11px] sm:tracking-[0.2em] ${
                  isCurrent
