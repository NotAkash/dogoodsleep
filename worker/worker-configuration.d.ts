/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: e1f04ddef51b3741bf3b670495dfd7d6)
// Runtime types generated with workerd@1.20260630.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	ARCHIVE_BUCKET: R2Bucket;
	LETTERBOXD_RSS_URL: "";
	STORYGRAPH_PROFILE_URL: "";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LETTERBOXD_RSS_URL" | "STORYGRAPH_PROFILE_URL">> {}
}
